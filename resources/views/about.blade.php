  ...
  <main id="main">
    ...
    <section id="skills" class="skills">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Habilidades</h2>
          <p>Estas são algumas habilidades que possuo, algumas úteis, outras nem tanto :)</p>
        </div>
        ...
        <div class="row skills-content">
          ...
          <div class="col-lg-6">
            ...
            <div class="progress">
              <span class="skill">Truco <i class="val">80%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="80" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Fifa 23 <i class="val">90%</i></span>
              <div class="progress-bar-wrap">
                <div class="progress-bar" role="progressbar" aria-valuenow="90" aria-valuemin="0" aria-valuemax="100"></div>
              </div>
            </div>
            ...
            <div class="progress">
              <span class="skill">Redstone <i class="val">1%</i></span>
              <div class="progress-bar-wrap">
